...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8">
            <h2>Document Delivery Tracking</h2><br>
            <div class="container-fluid">
                <div class="row">
                    <div class="btn-group btn-toggle" data-toggle="buttons">
                        <label class="btn btn-primary active">
                            <input name="options" value="option1" type="radio"> ALL(2)
                        </label>
                        <label class="btn btn-primary">
                            <input name="options" value="option2" type="radio"> Current(1)
                        </label>
                        <label class="btn btn-primary">
                            <input name="options" value="option3" type="radio"> Reject(0)
                        </label>
                    ...
                    <div class="row">
                        ...
                        <div class="visible-md visible-lg col-md-3 col-lg-3">
                            <img class="img-qrcode-maxsize" src="~/Content/Image/export.png">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-7 col-sm-9 col-md-6">
                            <b>Title :</b> <a class="text-info" href="http://192.168.74.221/psru/catalog/BibItem.aspx?BibID=b00006682" target="_blank">พ่อรวยสอนลูก : เงินสี่ด้าน / 	คิโยซากิ, โรเบิร์ต ที</a><br>
                            <br />
